...
#define UCON_TRANS_MODE_IRQ 			(1)
#define UCON_TRANS_MODE_DMA 			(2)
#define UCON_RECEIVE_MODE			(3 << 0)
#define UCON_RECEIVE_MODEx(x)			(x << 0)
#define UCON_RECEIVE_MODE_IRQ 			(1)
#define UCON_RECEIVE_MODE_DMA 			(2)

/* Fifo Control Register */
#define FCONx(x) 				__REGW(x + 0x4)
#define FCON_TX_FIFO_TRIGGER 			(3 << 6)
#define FCON_TX_FIFO_TRIGGERx(x)		(x << 6)
#define FCON_TX_FIFO_TRIGGER_0			(0)
#define FCON_TX_FIFO_TRIGGER_4			(1)
#define FCON_TX_FIFO_TRIGGER_8			(2)
#define FCON_TX_FIFO_TRIGGER_12			(3)
#define FCON_RX_FIFO_TRIGGER 			(3 << 4)
#define FCON_RX_FIFO_TRIGGERx(x)		(x << 4)
#define FCON_RX_FIFO_TRIGGER_0			(0)
#define FCON_RX_FIFO_TRIGGER_4			(1)
#define FCON_RX_FIFO_TRIGGER_8			(2)
#define FCON_RX_FIFO_TRIGGER_12			(3)
#define FCON_TX_FIFO_RESET 			(1 << 2)
#define FCON_RX_FIFO_RESET 			(1 << 1)
#define FCON_FIFO_EN 				(1 << 0)
